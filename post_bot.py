...
WELCOME = (
    ...
    "A focused Telegram-native clear-posts bot.\n\n"
    "📌 <b>Clear Posts</b> — view the available posts.\n"
    "📰 <b>Latest Post</b> — view the most recent post.\n"
    "✍️ <b>Create Post</b> — format your text as a clean post.\n\n"
    "Everything happens directly inside Telegram."
)

HELP_TEXT = (
    "<b>SB24GZ – ប៉ុស្តិ៍​ច្បាស់ៗ</b>\n\n"
    "Use this bot to view and prepare clear, readable posts directly inside Telegram.\n\n"
    "📌 Clear Posts — view available post content.\n"
    "📰 Latest Post — view the latest available post.\n"
    "✍️ Create Post — send text and receive a cleaned post.\n\n"
...
POSTS = [
    {
        "title": "SB24GZ Update",
        "body": "Welcome to the SB24GZ clear-posts feed. New content can be published directly inside Telegram.",
    }
]
...
async def help_handler_callback(callback: CallbackQuery) -> None:
    await callback.answer()
    if callback.message:
...
async def create_post_handler(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    if callback.message:
        await callback.message.edit_text(
            "<b>✍️ Create Post</b>\n\n"
            "Send your text and the bot will clean the spacing and return a readable post.\n\n"
